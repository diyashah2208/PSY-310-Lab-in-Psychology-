...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/diyashah/Desktop/PsychoPy_Lab in Psych/Stroop_Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/diyashah/Desktop/PsychoPy_Lab in Psych/Cond.xlsx'), 
        seed=None, 
    )
